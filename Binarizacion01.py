...
img_path = r"C:\Users\AOAL129300\OneDrive - ALPSGROUP\Documents\test\shoot_195_l_tbd.jpg"  # ← Ajusta esta ruta
...
try:
    ...
    cv2.createTrackbar("Brillo Azul", "Ajustes", 100, 200, nothing)
    ...
    print("Ha ocurrido una excepción durante la ejecución:")
    traceback.print_exc()
    input("Presiona Enter para salir...")
